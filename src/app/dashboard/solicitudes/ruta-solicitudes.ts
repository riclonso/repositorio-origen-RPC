...
export const RUTA_SOLICITUDES_DASHBOARD = "/dashboard/solicitudes";
...
export function construirRutaSolicitudesDashboard(pagina: number, estado?: EstadoSolicitudReemplazoCarga): string {
  ...
  return consulta ? `${RUTA_SOLICITUDES_DASHBOARD}?${consulta}` : RUTA_SOLICITUDES_DASHBOARD;
}
